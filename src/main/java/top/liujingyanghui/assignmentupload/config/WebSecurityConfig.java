...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
                ...
                .antMatchers("/api/auth/**","/resource/**","/api/busywork/package-download",
                        "/api/school/list","/api/city/list","/api/province/list").permitAll() // 登录注册等请求过滤
//				.antMatchers("/api/**").permitAll() // 测试
                .antMatchers("/*.html", "/favicon.ico", "/**/*.html", "/**/*.js", "/**/*.css")
                .permitAll() // 静态资源过滤
